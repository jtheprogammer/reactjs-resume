    ...
    experiences: [
      {
        ...
        description:
          "During my final 6 months at AMC, I had truly come to terms that a career as a research wasn't right for me, while also discovering my passion for IT and programming. Since the completion of this project, it's been about a year since I've left the doctoral program. During this time, I've gotten intimately familiar with the various technologies listed on, displayed throughout and/or used to create this website.",
      },
      {
        exp_id: 2,
        ...
        description:
          "My first year attending the Immunology and Microbial Disease doctoral program was spent rotating in labs, whose focused ranged from bacterial diseases, like Tuberculosis, to the neurological disease Alzheimer's. Eventually, I had decided to join Dr. Katherine MacNamara's lab, in which I studied the effects of tick-borne diseases on hematopoiesis (the process of producing blood cells).",
      },
      {
        exp_id: 1,
    ...
    experiences: [
      {
        ...
        description:
          "A temporary assistant position where I was responsible for the processing of grant applications for daycares during COVID-19. During this time, I assisted both English- and Spanish-speaking daycare providers.",
      },
      {
        exp_id: 3,
        ...
        date: "August 2018 - May 2021",
        description:
          "The summer following my graduation, I began attending the Immunology and Microbial Disease program at AMC. After completing freshman year courses and lab rotations, I joined Dr. Katherine MacNamara's lab. Conducting scientific research required me to constantly collect, analyze, interpret and visualize data.",
      },
      {
        exp_id: 2,
      ...
      },
      {
        ...
        description:
          "I assisted undergraduate students in preparing for exams and understanding concepts within natural science courses. \n The courses I tutored ranged from introductory (ie. BIO1/2, PHY1/2) to more advanced courses (ie. BIOCHEM1, Immunology).",
      },
    ],
  },
